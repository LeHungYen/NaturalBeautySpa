            ...
            <div className={style.menu}>
                <ul>
                    <div className={style.menuPosition}>
                        ...
                        <a href={routes.mainMenu}><li><MdKeyboardArrowRight className={style.icon} /> <p>脱毛メニュー</p> </li></a>
                        <li><MdKeyboardArrowRight className={style.icon} /> <p>脱毛</p></li>
                        <li><MdKeyboardArrowRight className={style.icon} /> <p style={{ color: "#2dccd3" }}>{menuItem[currentMenuItemIndex].titleArea.title}</p></li>
                    </div>
                </ul>
            </div >

            <div className={style.content}>
                <MenuComponent setCurrentMenu={setCurrentMenu} menuItem={menuItem} currentMenuItemIndex={currentMenuItemIndex} setCurrentMenuItemIndex={setCurrentMenuItemIndex} />
            </div>
        </div >
    );
}
